...
namespace JorisHoef.SessionHelper.Tests
{
    public sealed class SessionServiceTests
    {
        ...
        [Test]
        public async Task LoginSuccessStoresSession()
        {
        ...
        [Test]
        public async Task RestoreLoadsSession()
        {
        ...
        [Test]
        public async Task ExpiredTokenIsDetected()
        {
        ...
        [Test]
        public async Task RefreshUpdatesSession()
        {
        ...
        public async Task FailedRefreshClearsOrPreservesSessionBasedOnPolicy(
        ...
        [Test]
        public async Task SessionChangedEventFires()
        {
            var store = new InMemorySessionStore();
            var service = CreateService(store);
